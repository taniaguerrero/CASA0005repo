...
```{r Library Initial Packages, message=FALSE, warning=FALSE}
...
#our new db object contains lots of info including the cluster each set of point
#coordinates belongs to, whether the point is a seed point or a border point etc. 
#We can get a summary by just calling the object
```{r}
library(ggplot2)
```
...
#using the CRS() function in the raster package
```{r}
library(rgdal)
