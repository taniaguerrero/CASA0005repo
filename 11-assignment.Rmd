...
The literautre review should evaluate exisiting research, demonstrating contrasting and/or similar views whilst highlight research gaps (that hopefully your research will contribute to / address). This could also include policy documents or documents from reputable soruces. Methodology is what you did (analysis, data processing etc). 

Results is what you found --- be selective about figures you include and include a narrative, don't just present result after result. 
...
Your conclusion should restate what you set out to investigate, summarise how you acheived it, what your results showed and why it is important and in this case specifying recommendations (e.g. what should be changed or altered to fix the issue you explored). 
