...
knitr::include_url("https://www.youtube.com/IOpQg0BXYvw")
```

And this great YouTube produced by SciShow shows the comporsises of different geographic map projections 

```{r echo=FALSE, fig.align='center', cache=TRUE}
knitr::include_url("https://www.youtube.com/8I_VpC6IuJs")
```
...
36. To get a meaningful result we could run some more calucaltions on let's project our data
