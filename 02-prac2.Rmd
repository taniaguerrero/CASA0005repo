...
There seems to be an issue with ```read_osm()``` that means even the example data won't work. I've logged the issue on GitHub and stackexchange and will most likely get some pretty direct comments. Have a look:
...
Check out this resource for more options in ```ggplot```: https://www.r-spatial.org/r/2018/10/25/ggplot2-sf.html
